...
export default function FooterGlow() {
  ...
  <div className="flex flex-col items-center md:items-start">
    <a href="#" className="mb-4 flex items-center gap-2">
      <span className="flex h-9 w-9 items-center justify-center rounded-full bg-linear-to-br from-blue-500 to-indigo-700 text-2xl font-extrabold text-white shadow-md">
        <svg
      ...
      <span className="bg-linear-to-br from-blue-200 to-indigo-500 bg-clip-text text-xl font-semibold tracking-tight text-transparent">
        Velocity
      </span>
    </a>
    <p className="text-foreground mb-6 max-w-xs text-center text-sm md:text-left">
      Velocity empowers developers to deploy web apps instantly with built-in
      CI/CD, global edge delivery, and scalable cloud infrastructure.
    </p>
  ...
  <nav className="flex w-full flex-col gap-9 text-center md:w-auto md:flex-row md:justify-end md:text-left">
    <div>
      ...
      <ul className="space-y-2">
        <li><a href="#" className="text-foreground/70">Features</a></li>
        <li><a href="#" className="text-foreground/70">Pricing</a></li>
        <li><a href="#" className="text-foreground/70">Edge Network</a></li>
        <li><a href="#" className="text-foreground/70">Changelog</a></li>
      </ul>
    </div>
    <div>
      <div className="mb-3 text-xs font-semibold tracking-widest text-blue-400 uppercase">
      ...
      <ul className="space-y-2">
        <li><a href="#" className="text-foreground/70">About</a></li>
        <li><a href="#" className="text-foreground/70">Careers</a></li>
        <li><a href="#" className="text-foreground/70">Blog</a></li>
        <li><a href="#" className="text-foreground/70">Contact</a></li>
      </ul>
    </div>
    <div>
      <div className="mb-3 text-xs font-semibold tracking-widest text-blue-400 uppercase">
      ...
      <ul className="space-y-2">
        <li><a href="#" className="text-foreground/70">Docs</a></li>
        <li><a href="#" className="text-foreground/70">API Reference</a></li>
        <li><a href="#" className="text-foreground/70">Guides</a></li>
        <li><a href="#" className="text-foreground/70">Status</a></li>
      </ul>
    </div>
  </nav>
</div>
...
<div className="text-foreground relative z-10 mt-10 text-center text-xs">
  <span>&copy; 2025 Velocity. Deploy fast. Scale globally.</span>
</div>
